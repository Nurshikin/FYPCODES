...
int interval=3; //shikin (used to be 120)
int interval_ms;
int interval_update_ms=300;
int interval_edit_ms=1800;
int interval_counter = 0; //shikin (new)

int predefined_intervals[] = {3, 10, 15, 20};  // shikin (3s,10s,15s,20s)
...
// printArray(PFont.list());
 ...
 // pixelDensity(2);
  ...
  interval_ms= int(1000 * interval); //shikin (used to be (60000), convert intervals to ms)
